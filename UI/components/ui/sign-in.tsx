          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              <div className="animate-element animate-delay-300">
                ...
                <GlassInputWrapper>
                  <input name="usernameOrEmail" placeholder="Enter email or username" className="w-full rounded-2xl bg-transparent p-4 text-sm focus:outline-none" />
                </GlassInputWrapper>
              </div>
              ...
              {showAdminOption && (
                <button
                  ...
                  name="loginMode"
                  value="admin"
                  className="animate-element animate-delay-700 w-full rounded-2xl border border-border py-4 font-medium transition-colors hover:bg-secondary"
                >
                  Sign In as Admin
                </button>
              )}
            ...
            {bottomNote ? (
              <div className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">{bottomNote}</div>
            ) : null}
          </div>
        </div>
      </section>
