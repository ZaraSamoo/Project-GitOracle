...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[48rem] md:h-[65rem] flex items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[26rem] md:h-[34rem] w-full border border-zinc-700 p-2 md:p-6 bg-zinc-900 rounded-[30px] shadow-2xl"
    >
